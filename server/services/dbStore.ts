...
const BASELINE_MODELS: { id: string; name: string; provider: string; elo: number }[] = [
  ...
  { id: 'ag-gemini-35-flash-medium', name: 'Gemini 3.5 Flash (Medium)', provider: 'openai', elo: 2440 },
  { id: 'ag-gemini-31-pro-low', name: 'Gemini 3.1 Pro (Low)', provider: 'openai', elo: 2480 },
  { id: 'ag-gemini-3-flash-medium', name: 'Gemini 3 Flash (Medium)', provider: 'openai', elo: 2420 },
